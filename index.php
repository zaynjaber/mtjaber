							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>Zayn</strong> Jaber</h2>
										<p class="lead">Software Engineer, Web Development and Database Architect. </p>
        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <h3>About</h3>
                    <p class="lead">I am a student at Henry Ford College.</p>
                </div>
            </div><!-- end title -->
